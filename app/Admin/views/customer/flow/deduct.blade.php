...
@section('content')
    ...
    <div class="row"><div class="col-md-12"><div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">后台扣款</h3>

                    <div class="box-tools">
                        <div class="btn-group pull-right" style="margin-right: 10px">
                            <a href="{!! route('m.customer.flow.list') !!}" class="btn btn-sm btn-default">
...
@section('script')
    <script>
        var initialAjAx = {
            "url":"{!! route('m.customer.flow.deduct.money') !!}",
            "backUrl":"{!! route('m.customer.flow.list') !!}"
        };
        ...
        $(function() {
            ...
            var countMoney = function() {
                ...
                $('#count-money .no-margin').text('用户'+ num +' 扣款总金额' + fmoney(money * num))
            };
