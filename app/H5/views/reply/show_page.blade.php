                ...
                <div class="box">
                    <div class="con-1 clearfix">
                        ...
                        <p class="fr">
                            ...
                            <a class="review check-auth" href="{!! route('h.feedback.reply', ['reply_id' => $item->id]) !!}"><i class="fa fa-exclamation"></i></a>
                            @if(is_null($item->deleted_at))
                                <a class="reply-one-edit check-auth"  data-id="{{ $item->id }}" data-at="{{ $item->issuer }}" href="javascript:void(0)">
